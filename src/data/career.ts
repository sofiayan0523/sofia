...
// All copy is intentionally in zh-TW; English translations could be added later.
...
export const speakingItems = [
  ...
  { title: "2024 Meet Taipei (panelist)", link: "https://www.youtube.com/watch?v=h-CNy_IPJP4" },
  {
