export const zh = {
  ...
  "about.background": "現在我在 Numbers Protocol 做共同創辦人與成長策略長，參與建構內容來源與數位信任基礎建設。外面看起來是技術與市場；我實際上每天面對的是翻譯，把工程語言翻成使用者能採取行動的語言，也把人的猶豫翻回產品與策略。這幾年，我也把這套翻譯能力帶進企業 AI 顧問與培訓：不是把工具清單丟給團隊，而是陪他們把 AI Agent 的角色、界線和稽核紀錄落到日常工作。也因為這樣，我把自己定位成一種新型態的「AI 管理師」：同時帶人類同事，也帶一整排 AI 同事。",
